...
SOAP_FMAC1 const char** SOAP_FMAC2 soap_faultsubsubcode(struct soap*);	//dlq added at 20120303
SOAP_FMAC1 const char **soap_faultsubsubcode(struct soap *soap);
...
SOAP_FMAC1 void* SOAP_FMAC2 soap_mallocz(struct soap *soap, size_t n);		//dongliqiang added at 20120228
